...
.load_interface_terms <- function(lang){
  ...
  welcome.fr <- "<h1>Bienvenue dans <i>archeoViz</i> !</h1>
                ...
                <a href=https://github.com/sebastien-plutniak/archeoviz target=_blank>d\\u00e9p\\u00f4t github</a>."
  # : en ----
  welcome.en <- "
...
<ul>
<li>Plutniak, S\\u00e9bastien. 2023. \\u201carcheoViz. Visualisation, Exploration, and Web Communication of Archaeological Excavation Data\\u201d. v0.2.1, DOI: <a href=https://doi.org/10.5281/zenodo.7512526>10.5281/zenodo.7512526</a>.</li>
</ul>
"
...
<div class=sourceCode id=cb3><pre class=sourceCode r><code class=sourceCode r><a class=sourceLine id=cb3-1 data-line-number=1><span class=co># d\\u00e9terminez le r\\u00e9pertoire de travail dans votre shiny server:</span></a>
<a class=sourceLine id=cb3-2 data-line-number=2><span class=kw>setwd</span>(<span class=dt>dir =</span> <span class=st>&quot;/some/path/&quot;</span>)</a>
<a class=sourceLine id=cb3-3 data-line-number=3><span class=co># t\\u00e9l\\u00e9chargez le package:</span></a>
...
<a class=sourceLine id=cb3-6 data-line-number=6><span class=co># d\\u00e9compression:</span></a>
...
<a class=sourceLine id=cb4-4 data-line-number=4>          <span class=dt>title =</span> <span class=ot>NULL</span>,        <span class=co># titre du site / du jeu de donn\\u00e9es</span></a>
...
<a class=sourceLine id=cb4-7 data-line-number=7>          <span class=dt>set.theme =</span> <span class=st>&quot;cosmo&quot;</span>) <span class=co># th\\u00e8me graphique de l'interface Shiny</span></a></code></pre></div>
